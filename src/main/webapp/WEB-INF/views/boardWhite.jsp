...
<title>글 작성하기</title>
 ...
 <link href="https://stackpath.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" rel="stylesheet">
  ...
  <link rel="stylesheet" href="/css/boardWhite.css">
<body>
<div class="wrap">
	...
	<main class="main-container">
		<form class="boardWhite-form" action="/boardWhite" onSubmit="check();return flase" method="POST">
			 <div class="title-container">
				<input name="title" type="text" placeholder="제목....."/>
				<input name="userNo" type="hidden"  value="${userConfig.idx }">
			 </div>
